...
static var follow_AI = func(_self:Obj_function ,value):
...
static var spider_AI = func(_self:Obj_function ,value):
...
static var butterfly_AI = func(_self:Obj_function ,value):
...
static var shoot_AI = func(_self:Obj_function ,value):
...
static var loong_AI = func(_self:Obj_function ,value):
	var delta = value.get("delta", 0.0)
	if  _self.get_item_info("follow_monster", null) == null:
		Register_table.handlers["shoot"].call(_self, delta)
		var world:World = _self.get_father()
...
static var spin_AI = func(_self:Obj_function ,value):
	var delta = value.get("delta", 0.0)
	_self.spin( _self.get_item_info("spin_rate", 0) * delta)

static var self_bomb_AI = func(_self:Obj_function ,value):
	var delta = value.get("delta", 0.0)
	var world:World = _self.get_father()
	var follow_pos = world.get_rider().get_obj_position()
...
static var aim_bullet_AI = func(_self:Obj_function ,value):
	var world:World = _self.get_father()
...
static func _static_init():
	Register_table.handlers["follow"] = follow_AI
	Register_table.handlers["spider"] = spider_AI
	Register_table.handlers["maggot"] = maggot_AI
	Register_table.handlers["abandon"] = abandon_AI
	Register_table.handlers["butterfly"] = butterfly_AI
	Register_table.handlers["shoot"] = shoot_AI
	Register_table.handlers["loong"] = loong_AI
	Register_table.handlers["spin"] = spin_AI
	Register_table.handlers["self_bomb"] = self_bomb_AI
	Register_table.handlers["aim_bullet"] = aim_bullet_AI
